...
`])),function(h){return h.theme.spaces[2]},function(h){return h.pullRight?"auto":void 0}),E=u()(s)(n||(n=c()([`
  flex-shrink: 0;
`]))),R=function(h){var y=h.startActions,x=h.endActions;return y||x?i.a.createElement(f.Box,{paddingLeft:10,paddingRight:10},i.a.createElement(f.Box,{paddingBottom:4},i.a.createElement(t.Flex,{justifyContent:"space-between",alignItems:"flex-start"},y&&i.a.createElement(s,{wrap:"wrap"},y),x&&i.a.createElement(E,{pullRight:!0},x)))):null};R.defaultProps={endActions:void 0,startActions:void 0},R.propTypes={endActions:g.a.node,startActions:g.a.node};var N=function(h){var y=h.children;return i.a.createElement(f.Box,{paddingLeft:10,paddingRight:10},y)};N.propTypes={children:g.a.node.isRequired};var G,M=e(4),v=e.n(M),A=e(6),j=e.n(A),I=e(10),P=e.n(I),k=e(8),Y=e(48),$=["navigationAction","primaryAction","secondaryAction","subtitle","title","sticky","width"],an=function(){var h=Object(d.useRef)(null),y=Object(d.useState)(null),x=P()(y,2),B=x[0],C=x[1],_=function(F){var z=Object(d.useRef)(null),sn=Object(d.useState)(!0),rn=P()(sn,2),cn=rn[0],dn=rn[1],ln=function(D){var U=P()(D,1)[0];dn(U.isIntersecting)};return Object(d.useEffect)(function(){var D=z.current,U=new IntersectionObserver(ln,F);return D&&U.observe(z.current),function(){D&&U.disconnect()}},[z,F]),[z,cn]}({root:null,rootMargin:"0px",threshold:0}),W=P()(_,2),H=W[0],K=W[1];return Object(Y.a)(H,function(){H.current&&C(H.current.getBoundingClientRect())}),Object(d.useEffect)(function(){h.current&&C(h.current.getBoundingClientRect())},[h]),{containerRef:H,isVisible:K,baseHeaderLayoutRef:h,headerSize:B}},Q=function(h){var y=an(),x=y.containerRef,B=y.isVisible,C=y.baseHeaderLayoutRef,_=y.headerSize;return i.a.createElement(i.a.Fragment,null,i.a.createElement("div",{style:{height:_==null?void 0:_.height},ref:x},B&&i.a.createElement(L,j()({ref:C},h))),!B&&i.a.createElement(L,j()({},h,{sticky:!0,width:_==null?void 0:_.width})))};Q.displayName="HeaderLayout";var un=u()(f.Box)(G||(G=c()([`
  position: fixed;
  top: 0;
  right: 0;
  width: `,`px;
